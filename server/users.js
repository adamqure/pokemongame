...
router.put('/win', auth.verifyToken, User.verify, async (req, res) => {
  let user = req.user;

  user.correctValue++;
  user.currentStreak++;
  if (user.currentStreak > user.longestStreak) {
    user.longestStreak = user.currentStreak.valueOf()
  }
  console.log("Winning Stats: ");
  console.log("Correct: " + user.correctValue);
  console.log("Incorrect: " + user.incorrectValue);
...
router.put('/lose', auth.verifyToken, User.verify, async (req, res) => {
  let user = req.user;
  user.incorrectValue++;
  user.currentStreak = 0;
  console.log("Losing Stats: ");
  console.log("Correct: " + user.correctValue);
  console.log("Incorrect: " + user.incorrectValue);
  console.log("Current Streak: " + user.currentStreak);
  console.log("Longest Streak: " + user.longestStreak);
